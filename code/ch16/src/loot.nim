...
proc label*(kind: PickupKind): string =
  ## What the hover UI calls each pickup.
  case kind
  of pkCoin: "coin"
  of pkKey: "the seal key"
  of pkHeart: "heart"
  of pkMaxHp: "heart container"
  of pkPower: "sword power"
  of pkCrown: "the crown of Nimrod"
...
proc applyPickup*(w: var World, player: Entity, power: var int32,
  ...
  of pkPower:
    inc power
  of pkCoin, pkKey, pkCrown:
    discard   # they mean something to the run, not to the knight's body
