## Chapter 14: the crypt learns to sell a hit. Particles (a structure
## of arrays, pointedly not the ECS), trauma-based screen shake,
## hurt-flash tints, i-frame blinking, and hitstop: three frozen
## frames that make a sword feel like it weighs something.

import std/[math, options, random]
import raylib, raymath
import audio, camera, debug, dungeon, ecs, hud, input, loot, particles,
       resources, sprites, systems, tilemap
