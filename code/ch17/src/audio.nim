...
type
  ...
  Sfx* = enum
    ...
    sfxStairs, sfxKill, sfxGameOver, sfxStart, sfxRoar, sfxVictory
...
proc loadAudioBank*(): AudioBank =
  ...
  result.sounds[sfxRoar] = toSound(mix(
    tone(130, 40, 0.55, shSquare, 0.40),
    tone(600, 90, 0.55, shNoise, 0.18)))
  result.sounds[sfxVictory] = toSound(
    tone(523, 523, 0.12, shSine, 0.35) &
    tone(659, 659, 0.12, shSine, 0.35) &
    tone(784, 784, 0.30, shSine, 0.35))   # C, E, G: the tonic earned
